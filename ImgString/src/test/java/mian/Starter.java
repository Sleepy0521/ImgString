...
import mian.CalculateCharArea.CharArea;
...
public class Starter {
    ...
    private static BufferedImage zoom(BufferedImage source_bi) throws IOException{
        ...
        File file = new File("src/main/resources/final.jpg");
...
//      System.out.println(ratio);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //引入文件
        InputStream imageis = TransTool.class.getClassLoader().getResourceAsStream("abc.png");
